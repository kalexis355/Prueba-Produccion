...
@Component({
  selector: 'app-dashboard-migrado',
  templateUrl: './dashboard-migrado.component.html',
  styleUrl: './dashboard-migrado.component.scss'
})
export class DashboardMigradoComponent implements OnInit {
